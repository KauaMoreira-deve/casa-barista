    ...
    <section class="site rodape-grid">
        ...
        <div class="coluna-reserva">
            <div class="box-reserva">
                ...
                <div class="linha-box">
                    <hr>
                    <img src="{{ asset('assets/coffee-footer.svg')}}" alt="Faça sua reserva">
                    <hr>
                </div>
                <ul>
                    <li>
            ...
            <div class="box-email">
                ...
                <form action="{{ route('home')}}" method="post">
                    ...
                    <button type="submit" aria-label="Enviar">
                        <img src="{{ asset('assets/arrow.svg')}}" alt="Botão Enviar">
                    </button>
                </form>
            </div>
        </div>
            ...
            <ul class="redeSocial">
                <li>
                    <a href="#" target="_blank">
                        <img src="{{ asset('assets/facebook-24.png') }}" alt="Logo Facebook - Casa do Barista">
                    </a>
                </li>
                <li>
                    <a href="#" target="_blank">
                        <img src="{{ asset('assets/instagram-24.png') }}" alt="Logo Instagram - Casa do Barista">
                    </a>
                </li>
                <li>
                    <a href="#" target="_blank">
                        <img src="{{ asset('assets/linkedin-24.png') }}" alt="Logo LinkedIn - Casa do Barista">
                    </a>
                </li>
                <li>
                    <a href="https://wa.me/5511988662233?text=Ol%C3%A1%21%20Gostaria%20de%20falar%20com%20a%20Casa%20Do%20Barista%20%E2%98%95"
                        target="_blank">
                        <img src="{{ asset('assets/whatsapp-24.png') }}" alt="Logo WhastApp - Casa do Barista">
                    </a>
                </li>
            </ul>
