                ...
                <div class="card mb-4">
                              ...
                              <tr class="cont-linha">
                                <td>
                                  <div class="d-flex align-items-center">
                                    ...
                                    <span class="fw-medium">{{ $depo->id_depoimentos }}</span>
                                  </div>
                                </td>
                                ...
                                <!--TITULO GALERIA -->
                                  ...
                                  <td class="col">
                                      <span class="badge text-bg-danger"> {{ $depo->DepoimentoCliente->nome_cliente }} </span>
                                  </td>
              
                                <td>
                                  <span class="badge text-bg-danger">{{ $depo->descricao_depoimentos }}</span>
                                </td>
                                <td>

                                @if ($depo->status_depoimentos === 'APROVADO')
                                    <span class="badge text-bg-success">APROVADO</span>
                                @else
                                    <span class="badge text-bg-danger inativo">PENDENTE</span>
                                @endif
                  ...
                  <div class="card-footer clearfix">
                    <div class="float-start pt-1 fs-7 text-body-secondary col">
                      Total de depoimentos: {{ $listaDepo->count() }}
                    </div>
