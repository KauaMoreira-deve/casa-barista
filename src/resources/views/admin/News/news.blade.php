                  ...
                  <div class="card-header">
                    <div class="row g-2 align-items-center">
                      <div class="col-12 col-md-4">
                        <h3 class="card-title">Emails ativos</h3>
                      </div>
                          ...
                          <tr class="cont-linha">
                            <td>
                              <div class="d-flex align-items-center">
                                ...
                                <span class="fw-medium">{{ $new->id_news }}</span>
                              </div>
                            </td>
                            ...
                            <td class="col">
                              <div class="d-flex align-items-center">
                                <span class="fw-medium">{{ $new->email_news }}</span>
                              </div>
                            </td>
                            <td>
                              @if ($new->aceite_news === 1)
