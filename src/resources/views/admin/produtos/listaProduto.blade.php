                              ...
                              <tr class="cont-linha">
                                ...
                                <td>
                                  <div class="d-flex align-items-center">
                                    ...
                                    <span class="fw-medium">{{ $produto->id_produto }}</span>
                                  </div>
                                </td>
                                ...
                                <!--IMAGEM PRODUTO -->
                                  ...
                                  <td class="col">
                                    <img src="{{ "barista/assets/$produto->imagem_produto" }}" alt="{{ $produto->nome_produto }}" style="max-width: 50px; max-height: 50px;">
                                  </td>
                                  <!--NOME PRODUTO -->
                                  <td class="col">
                                    <span class="badge text-bg-danger">{{ $produto->nome_produto }}</span>
                                  </td>
                                  <!--CATEGORIA PRODUTO -->
                                  <td class="col">
                                    <span class="badge text-bg-primary">{{ $produto->categoria->nome_categoria }}</span>
                                  </td>
                                  ...
                                  <!--descricao PRODUTO -->
                                  <td class="col">
                                    <span class="badge text-bg-primary">{{ $produto->descricao_curta_produto}}</span>
                                  </td>

                                  <!--VALOR PRODUTO -->

                                <td class="col">
                                  <span class="badge text-bg-primary">R$ {{ number_format($produto->valor_produto, 2, ',', '.') }}</span>
                                </td>
