                ...
                <div class="card mb-4">
                          ...
                          <tr class="cont-linha">
                            ...
                            <td>
                              <div class="d-flex align-items-center">
                                <span class="fw-medium">{{ $linhaTempo->id_linha_tempo }}</span>
                              </div>
                            </td>

                            <!--TITULO linha tempo -->
                            <td>
                               <span class="fw-medium">{{ $linhaTempo->titulo_linha_tempo }}</span>
                            </td>

                            <!--ANO linha tempo -->
                            <td>
                              <span class="badge text-bg-danger">{{ $linhaTempo->ano_linha_tempo }}</span>
                            </td>
                           
                            <!--DESCRICAO linha tempo -->
                            <td>
                              <span class="fw-medium">{{ $linhaTempo->descricao_linha_tempo }}</span>
                  ...
                  <div class="card-footer clearfix">
                    ...
                    <div class="float-start pt-1 fs-7 text-body-secondary col">
                      Total de linhas: {{ $linhasTempo->count() }}
                    </div>
