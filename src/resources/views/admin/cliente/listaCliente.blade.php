                ...
                <div class="card mb-4">
                              ...
                              <tr class="cont-linha">
                                <td>
                                  <div class="d-flex align-items-center">
                                    ...
                                    <span class="fw-medium">{{ $cliente->id_cliente }}</span>
                                  </div>
                                </td>
                                ...
                                <!--TITULO GALERIA -->
                                  ...
                                  <td class="col">
                                      <img src="{{ asset("barista/assets/" . $cliente->foto_cliente) }}" alt="{{ $cliente->nome_cliente }}" style="max-width: 50px; max-height: 50px;">  
                                  </td>
              
                                <td>
                                  <span class="badge text-bg-danger">{{ $cliente->email_cliente }}</span>
                                </td>
                                <td>
                  ...
                  <div class="card-footer clearfix">
                    <div class="float-start pt-1 fs-7 text-body-secondary col">
                      Total de depoimentos: {{ $clientes->count() }}
                    </div>
