                ...
                <div class="card mb-4">
                              ...
                              <tr class="cont-linha">
                                <td>
                                  <div class="d-flex align-items-center">
                                    ...
                                    <span class="fw-medium">{{ $usuario->nome_usuarios }}</span>
                                  </div>
                                </td>
                                ...
                                <!--TITULO GALERIA -->
                                  ...
                                  <td class="col">
                                      <img src="{{ asset("barista/assets/" . $usuario->foto_usuarios) }}" alt="{{ $usuario->nome_usuarios }}" style="max-width: 50px; max-height: 50px;">  
                                  </td>
              
                                <td>
                                  <span class="badge text-bg-danger">{{ $usuario->email_usuarios }}</span>
                                </td>

                                <td>
                                  <span class="badge text-bg-primary">{{ $usuario->nivel_usuarios }}</span>
                                </td>
                  ...
                  <div class="card-footer clearfix">
                    <div class="float-start pt-1 fs-7 text-body-secondary col">
                      Total de usuários: {{ $listaUsuarios->count() }}
                    </div>
