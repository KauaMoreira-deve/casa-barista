<section class="destaque">
    ...
    <div class="site card wow animate__animated animate__fadeInUp">
        <article>
            <img src="assets/destaque1.png" alt="Casa do Barista - O sabor intenso de uma extração perfeita">
        ...
        <article>
            <img src="assets/destaque2.png" alt="Casa do Barista - Métodos de preparo artesanais">
            <h4>Coado tradicional</h4>
            <h5>Trabalhamos com fazendas familiares e microlotes que garantem qualidade e história.</h5>
        </article>

        <article>
            <img src="assets/destaque3.png" alt="Casa do Barista - Métodos de preparo artesanais">
